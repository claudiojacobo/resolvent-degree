...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5); _sage_const_50 = Integer(50); _sage_const_4 = Integer(4); _sage_const_2 = Integer(2); _sage_const_37 = Integer(37); _sage_const_7 = Integer(7)
...
G = PSU_Characters (_sage_const_2 , _sage_const_37 )
print("2, 37")
for character in G. characters:
    print(G. the_game (character, _sage_const_7 ))
H = GroupCharacters ("PSU(2, 37)")
print(" normal 2, 37")
for character in H. characters:
    print(H. the_game (character, _sage_const_7 ))
G. display()
H. display()
