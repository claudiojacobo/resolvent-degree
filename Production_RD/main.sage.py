...
_sage_const_100 = Integer(100); _sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_6 = Integer(6); _sage_const_0 = Integer(0)# load("group_characters.sage")
