...
_sage_const_6 = Integer(6); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_1 = Integer(1); _sage_const_11 = Integer(11)
...
G = PSU_Characters(_sage_const_3 , _sage_const_4 )
