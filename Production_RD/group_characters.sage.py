...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_6 = Integer(6)
import math
...
class GroupCharacters:
    ...
    def the_game(self, chi):
        ...
        alg_indp_poly = generators_from_molien(self.molien_coeff(chi, _sage_const_10 )) # place holder while this function is being developed
