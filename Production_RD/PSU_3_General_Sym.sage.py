...
def C_6_klm_sym_fourth_explicit(modulus):
    ...
    if a % _sage_const_4  != _sage_const_0 :
        ...
        # Case 3b
        if a % _sage_const_8  == _sage_const_0 :
            C4Counter += floor((ceil(r*_sage_const_7 /_sage_const_12 ) - _sage_const_1  - ceil(r/_sage_const_4 ) + _sage_const_1 )/_sage_const_2 )
        if a % _sage_const_8  == _sage_const_4 :
        ...
        C1Counter += _sage_const_1 
    return (C1Counter, _sage_const_0 , _sage_const_0 , C4Counter, _sage_const_0 , _sage_const_0 , tpp - rpp - C4Counter, _sage_const_0 , _sage_const_0 )
