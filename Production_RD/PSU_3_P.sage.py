...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7); _sage_const_8 = Integer(8); _sage_const_6 = Integer(6); _sage_const_50 = Integer(50); _sage_const_12 = Integer(12); _sage_const_9 = Integer(9); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_24 = Integer(24); _sage_const_31 = Integer(31)
...
class GroupCharactersPSU3(GroupCharacters):
    ...
    def C_6_klm_sym_squared_explicit(self):
        ...
        if a in [_sage_const_4 , _sage_const_8 ]:
            total = -_sage_const_1  * math.floor(r/_sage_const_4 ) + _sage_const_1  + math.floor(r/_sage_const_6 ) + r/_sage_const_2  + math.floor((math.ceil(r/_sage_const_6 ) - _sage_const_1 )/_sage_const_2 ) - _sage_const_1 
            return total
        if a == _sage_const_6 :
...
i = _sage_const_0 
G = GroupCharactersPSU3(_sage_const_31 , _sage_const_1 )
for g in G.classes:
...
for g in G.classes:
    if g[_sage_const_2 ] == "6" and g[_sage_const_3 ] != "'":
        if G.power_of(g, _sage_const_3 )[_sage_const_2 ] != "6":
            print(g)
            print(f"g cubed is {G.power_of(g, _sage_const_3 )}")
            i += _sage_const_1 
...
for g in G.classes:
    if g[_sage_const_2 ] == "6" and g[_sage_const_3 ] != "'":
        if G.power_of(g, _sage_const_4 )[_sage_const_2 ] != "6":
            print(g)
            print(f"g to the fourth is {G.power_of(g, _sage_const_4 )}")
            i += _sage_const_1 
